...
import { ChevronLeft, ChevronRight, X, BookOpen, List } from "lucide-react";
...
export function BookReaderPage() {
  ...
  if (!book) {
    return (
      <div className="flex items-center justify-center min-h-screen">
        ...
        <div
          className="rounded-xl border shadow-sm w-full max-w-md overflow-hidden p-8 text-center"
  ...
  const currentChapter =
    sortedChapters[currentChapterIndex] || sortedChapters[0];
  ...
  const goToPrevious = () => {
    if (hasPrevious) {
      navigate(`/book/${bookId}/read/${sortedChapters[currentIdx - 1].id}`);
    }
  };
  ...
  }, [hasPrevious, hasNext, currentIdx]);
      ...
      <div className="w-full max-w-5xl relative">
        ...
        <div
          ...
          style={{
            ...
            minHeight: "600px",
            boxShadow:
              "0 20px 60px rgba(0,0,0,0.5), inset 0 0 20px rgba(0,0,0,0.1)",
          }}
        >
          ...
          <div
            className="max-w-none font-serif leading-relaxed mb-16 mx-auto"
            style={{ color: "#333333" }}
          >
          ...
          <div className="absolute bottom-8 left-0 right-0 flex justify-between px-8">
            ...
            <button
              ...
              style={{
                color: hasPrevious ? "#D4A574" : "#999999",
